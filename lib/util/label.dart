...
class Labels {
  ...
  static const shoulders = [
    ...
    {"name": "天刹罗衫肩", "description": "锦缎上绣有九天罗刹图腾，佩戴此肩者仿若能御天下之邪，正邪两道皆对其忌惮三分。"},
    {"name": "紫霞幻影肩", "description": "掠过紫霞峰顶，烟霞仙女遗下的肩甲，轻如羽翼，蕴含着仙界的悠然之气。"},
    {"name": "苍穹游龙肩", "description": "云中神龙，春风得意，这对肩甲上刻有游龙戏珠图案，龙形腾踔，神威莫测，冠绝武林。"},
  ...
  static const cloaks = [
    ...
    {"name": "逍遥游龙裳", "description": "游龙裳纹以逍遥二字为核心，缠绕龙形，衣动如龙游天际，置身其中，心也随之逍遥。"},
    {
      "name": "星辰河汉鹤氅",
      "description": "寓有河汉星辰之灵动，鹤氅轻盈若随风飘摇，星光闪烁，犹如夜空下闲云野鹤，淡然超脱。"
    },
    {"name": "离火朝阳旗袍", "description": "此旗袍以离火红绸制成，色彩艳丽如朝阳初升。穿之者宛如火凤凰般不凡，傲视千军。"},
    {
      "name": "碧落苍穹护身符",
    ...
    {"name": "飞雪寒露袍", "description": "袍如飞雪覆盖，涤尘寒露，纯洁无瑕。随身动作，冷意袭人，却有令人心旷神怡之效。"},
    {"name": "紫电青霜锦", "description": "锦上绣以紫电青霜，似乎蕴含无穷威能。触之即感电光石火，霜冻千里。"},
    {"name": "灵犀望月领", "description": "领口镶嵌灵犀一角，精致剔透。令着者心境通明，俨然能与月亭亭交辉映，情意绵绵。"},
    {"name": "山海云韵披风", "description": "披风绘有山海纹理，如同古籍中山海经的神韵，一袭之下，恍若漫步云端，探古穷幽。"},
    ...
    {"name": "焜煌日耀蟒袍", "description": "蟒袍以日为魂，焜煌辉耀，金线细密如火之焰，于日光下更显尊贵非凡，气若神灵。"},
    {
      "name": "苍穹之翼翎甲",
  ...
  static const breastplates = [
    ...
    {"name": "玄武重铠", "description": "此铠厚重稳固，乃是道家镇派的至宝，穿着后宛如玄武附体，四方不动，堪称防御之极。"},
    {
      "name": "炎帝战甲",
  ...
  static const wrists = [
    {
      "name": "玉龙绕腕",
      "description": "此护腕用寒玉雕琢而成，透着淡淡的青光。佩戴之后，能感受到一股清凉之意，仿佛身置幽谷，细听玉龙咆哮，有益于修心养性。"
    },
    {
      "name": "腾蛟守腕",
    ...
    {"name": "碧波灵腕", "description": "碧玉打造的护腕，清澈见底，佩戴此物，如同在江湖中独行一条清流，练达内外兼修之道。"},
    {
      "name": "九曲黄河束",
  ...
  static const belts = [
    ...
    {
      "name": "血煞鬼面带",
      "description": "鬼面狰狞，血色斑斓。传说此带曾为一位邪派高手所用，内蕴血气之煞，佩之者战力惊人，但需心性坚定，否则易受内魔侵蚀。"
    },
    {
      "name": "夜行僧踪带",
    ...
    {
      "name": "天罡北斗绶",
      "description": "此带内嵌众星，布局如北斗七星，夜夜闪烁，代表着武学至高无上的成就。佩戴者朝夕得见天罡之象，对抗诸多挑战有如神助。"
    },
    {
      "name": "碧海潮声束",
    ...
    {
      "name": "白虎绞金带",
      "description": "腰带金光闪闪，上绣白虎图腾，具有很强的威慑力。白虎为武者之魂，此带不仅加固身防，更能震慑邪魔外道。"
    }
  ];
  ...
  static const shins = [
    {
      "name": "青龙偃月膝",
      "description":
          "这护腿上刻有一条盘旋的青龙，伴随着风云变幻，偃月形的护板宛如利刃，割裂空气，保护着武者不受丝毫侵犯。穿上此膝，如同赵子龙战场杀敌，所向披靡。"
    },
    {
      "name": "玄武磐石腿",
      "description": "沉着坚毅如同北方神兽玄武，这护腿如同磐石般沉重稳固。穿戴者似可以感受到大地的力量，脚踏实地，无惧任何狂风暴雨。"
    },
    {
      "name": "朱雀翎羽裤",
      "description":
          "裤身绣着朱雀的羽翎图案，每一根羽毛都仿佛燃烧着火焰，流光溢彩。传说穿上它便能感受到朱雀的高贵与神速，气宇轩昂，武艺更进一层。"
    },
    {
      "name": "白虎战靴",
      "description": "此靴轻盈异常，上面刻着古老而神秘的白虎图腾。战靴内藏锋利之力，使得步伐间亦有凌厉之势，于无形间给敌人以致命一击。"
    },
    {
      "name": "紫微护法裆",
      "description": "星辰流转的紫色丝线穿插其间，穿着此护裆犹如受到紫微星官的庇护，使得武者在攻守转换间更显游刃有余。"
    },
    {
      "name": "昊天云行裤",
      "description": "仿若云霄之上的天空，此裤随行动飘然如行云流水。昊天之力溢于其上，赋予穿着者得天独厚的灵动与自由。"
    },
    {
      "name": "九州步霜靴",
      "description": "靴底踩过之处，寒霜生，仿若穿越千山万水的游侠，踏步间无声息，又冷若冰霜，令敌手心生畏惧。"
    },
    {"name": "太虚幻影袜", "description": "轻如鸿毛，若隐若现，穿上此袜如入无人之境，步履高深莫测，敌人徒呼奈何。"},
    {
      "name": "八荒征尘裤",
      "description": "此裤子布满了岁月的痕迹，见证了无数激战，每一次劈斩都是历练的积累，让穿戴者如同征战八荒的侠士，所向皆惊破天际。"
    },
    {
      "name": "风雪连云靴",
      "description": "白色如雪，流利如风。这靴子在寒风中犹如归雁划过长空，虽在雪地行走，却不留下半点痕迹，影响若存若亡。"
    },
    {
      "name": "黄泉路绝袍",
      "description": "此袍上绣有奇幻的图案，如同引领至阴间的黄泉，穿之者的身法莫测高深，令敌手如堕黄泉，再无回天之力。"
    },
    {
      "name": "苍穹雷动腿",
      "description": "所步之地，雷鸣万千。其上刻有雷纹，穿戴者行动间仿佛操纵着天地之间的惊雷，震撼四方。"
    },
    {
      "name": "八方风云膝",
      "description": "此护膝上刻画着风云变幻的图案，传说穿上之后能舞动风云，呼风唤雨，在浮华世界中游刃有余。"
    },
    {"name": "行云流水靴", "description": "此靴轻盈若水云流转，步履生风，穿之者宛如身处云端，如梦如幻，翩然物外。"},
    {
      "name": "五行缚魔裤",
      "description": "集五行之力于一身，这护腿蕴含了金木水火土的力量，缚住一切邪魔，保障穿戴者如稳如泰山。"
    },
    {
      "name": "凌霄宝雪靴",
      "description": "如凌霄之宝雪，这靴子纯白无垢，轻若无物。然其实蕴含蓬勃力量，使得行走如飞，踏雪无痕。"
    },
    ...
    {
      "name": "碧落黄泉裆",
      "description": "这护裆的颜色如同深不可测的海水，暗藏着至阳至刚的力量，能让穿戴者稳如磐石，宛若黄泉之下的修罗，迈步不惧生死。"
    }
  ];
  ...
  static const rings = [
    {
      "name": "琉璃云梦环",
      "description": "此环彷如琉璃仙境之物，佩戴于指，使人恍若步入了幽深的云梦泽，身处仙雾缭绕之中，心神怡然自得。"
    },
    {"name": "溪影寒光戒", "description": "银戒如溪水映影，透出丝丝寒气。戴此戒者，仿佛能感受到江湖的冷暖和世态的无情。"},
    {"name": "玄武绛血指", "description": "此戒由玄武献血精铸，戴之如身临古战场，寒光闪闪，犹能听见金戈铁马之声长鸣。"},
    {"name": "青丘狐媚戒", "description": "传说此戒为青丘狐仙所制，戒身隐隐流转不定，犹如狐仙般妩媚动人，让人心生迷离。"},
    {"name": "墨客风流戒", "description": "此戒似有翩翩佳士风度，佩之指上，令人文思泉涌，墨香沁心，犹如行走江湖的浪子。"},
    {"name": "紫电青霜指", "description": "紫电青霜，天地奇观，此戒似乎藏有天地间最磅礴的力量，令人目眩神迷，无人可挡。"},
    {"name": "幻魂罗刹戒", "description": "幻魂罗刹，异族之物，此戒上刻有诡秘符文，似能通灵异世，令神魂颠倒，鬼神莫测。"},
    {"name": "龙泉碧玉指", "description": "出自龙泉古刹的圣物，此戒通体碧玉，内藏佛音梵唱，可使人心灵净化，远离尘世纷争。"},
    {"name": "鸿蒙天罡戒", "description": "施展此戒，可感鸿蒙初辟之力，天罡北斗之威，使人如坐云端，掌握乾坤。"},
    {
      "name": "烈焰焚心指",
      "description": "火光映照之中，此戒似能焚尽一切，烈焰红深似血，为情所困者常戴，可焚心中一切杂念。"
    },
    ...
    {
      "name": "岁月流光戒",
      "description": "岁月悠悠，流光易逝，此戒能凝住一缕光阴，让人在波澜壮阔的江湖中，感受到时间的温柔。"
    },
  ...
  static const accessories = [
    {
      "name": "素锦瑶环",
      "description": "环内镶嵌碧玉，隐隐透出淡淡光泽，犹如江湖中那些隐姓埋名的高手，淡泊明志，闲云野鹤。"
    },
    {
      "name": "墨玉龙吟坠",
      "description": "黑玉雕刻成龙形，肌理栩栩如生，佩上身隐约传来龙吟之声，犹如大侠肝胆相照，行走江湖的豪情。"
    },
    {
      "name": "紫云流霞带",
      "description": "带中暗藏紫色丝线，宛如流霞般轻绕，佩戴之人仪态万千，走之江湖中，各色事情纷至沓来。"
    },
